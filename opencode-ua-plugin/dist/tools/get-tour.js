...
export const uaGetTour = Object.assign(tool({
    description: "Get a guided tour of the codebase for onboarding. " +
    ...
    async execute(args, ctx) {
        ...
        if (args.topic) {
            ...
            steps = steps.filter(s => s.title.toLowerCase().includes(q) ||
